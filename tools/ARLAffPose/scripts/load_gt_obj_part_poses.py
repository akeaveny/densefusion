...
def main():
    ...
    for image_idx, image_addr in enumerate(image_files):
        ...
        cv2_obj_parts_img = color_aff_label.copy()
        ...
        print("label_obj_part_ids: ", label_obj_part_ids)
            ...
            if obj_id in label_obj_ids:
                ...
                for obj_part_id in obj_part_ids:
                    if obj_part_id in label_obj_part_ids:
                        ...
                        # draw model
                        obj_parts_imgpts, jac = cv2.projectPoints(obj_part_centered * 1e3, obj_part_r, obj_part_t * 1e3, CAM_MAT, CAM_DIST)
